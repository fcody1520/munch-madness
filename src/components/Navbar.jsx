...
import { faUserGear,faGears,faToolbox, faClockRotateLeft } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      <div className="navbar">
        ...
        <div className="navbar__button">
          <div>
            <NavLink to='/history'>
              <FontAwesomeIcon size="3x" style={{color: "#22B5D7"}} icon={faClockRotateLeft} />
            </NavLink>
          </div>
          <div>
